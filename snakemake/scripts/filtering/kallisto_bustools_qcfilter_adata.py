...
def identify_doublets(adata, output_prefix):
    ...
    plt.savefig(f"{output_prefix}/doublet_histogram.pdf", bbox_inches='tight', pad_inches=0.1)
    plt.close()
    ...
    plt.savefig(f"{output_prefix}/doublet_umap.pdf", bbox_inches='tight', pad_inches=0.1)
    plt.close()
...
def qc_plots(adata, output_prefix=""):
    """
